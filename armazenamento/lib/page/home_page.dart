...
import 'package:armazenamento/page/contact_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _contactCard(BuildContext context, int index) {
    return GestureDetector(
      ...
      onTap: () {
        _showOtions(context, index);
      },
    );
  }

  void _showOtions(BuildContext context, int index) {
  ...
  _optionButton(BuildContext context, title, pressedFuncion) {
    return Padding(
      padding: EdgeInsets.all(10.0),
      child: ElevatedButton(
        onPressed: pressedFuncion,
        child: Text(
          title,
          style: TextStyle(
            color: Colors.white,
